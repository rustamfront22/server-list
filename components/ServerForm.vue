  ...
  <form class="flex flex-col items-center justify-center h-full lg:p-20 p-5">
    <blockquote class=" font-bold text-gray-500 mb-6">
      ...
      <p class="text-gray-400">
        Ниже представлены данные выбранного сервера. Вы можете изменить их и нажать кнопку "Сохранить", чтобы сохранить
        изменения
      </p>
    </blockquote>
    <div class="flex flex-col w-full">
      <label class="text-md font-bold text-gray-500 mb-2">Название сервера</label>
      <input
          id="server_name"
    ...
    <div class="flex flex-col w-full">
      ...
      <select
          class="w-full px-4 py-2 mb-4 text-lg text-gray-500 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-200 appearance-none bg-[url('/images/arrow-down.svg')] bg-no-repeat bg-right bg-[calc(100%_-_10px)_center] bg-white"
